...
java -cp ".;mysql-connector-j-9.x.x.jar" ui.src.loginPage
```

_Note: If compiling from Linux or macOS bash systems, replace the Windows semicolon path delimiter (`;`) with a standard colon flag (`:`)._
